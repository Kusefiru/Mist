...
<div class="flex max-w-[90%] items-center gap-4 text-ink-900 select-none">
    ...
    <div class="flex min-w-0 flex-col">
        ...
        <h4 class="truncate text-base font-semibold text-ink-800" title={track.album}>
            <a href="/app/album/{track.albumId}" class="hover:underline">
                {track.album}
            </a>
        </h4>
    </div>
    <Star id={track.id} size={"1.5rem"} />
</div>
